...
const toneClasses: Record<NonNullable<BadgeProps["tone"]>, { container: string; text: string }> = {
  ...
  success: { container: "bg-green-50 dark:bg-green-900/20", text: "text-green-700 dark:text-green-300" },
  warning: { container: "bg-yellow-100 dark:bg-yellow-900/20", text: "text-yellow-800 dark:text-yellow-300" },
  error: { container: "bg-red-100 dark:bg-red-900/20", text: "text-red-700 dark:text-red-300" },
